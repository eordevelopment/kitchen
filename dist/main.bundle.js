...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_items_service__ = __webpack_require__("../../../../../src/app/services/items.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_recipes_service__ = __webpack_require__("../../../../../src/app/services/recipes.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_form_helper_service__ = __webpack_require__("../../../../../src/app/services/form-helper.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_plan_service__ = __webpack_require__("../../../../../src/app/services/plan.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_app_services_shopping_list_service__ = __webpack_require__("../../../../../src/app/services/shopping-list.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_app_services_session_service__ = __webpack_require__("../../../../../src/app/services/session.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_app_app_shell_app_shell_component__ = __webpack_require__("../../../../../src/app/app-shell/app-shell.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_app_modules_recipe_recipe_module__ = __webpack_require__("../../../../../src/app/modules/recipe/recipe.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_app_modules_inventory_inventory_module__ = __webpack_require__("../../../../../src/app/modules/inventory/inventory.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_app_modules_plan_plan_module__ = __webpack_require__("../../../../../src/app/modules/plan/plan.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_app_modules_welcome_welcome_module__ = __webpack_require__("../../../../../src/app/modules/welcome/welcome.module.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_11_app_services_session_service__["a" /* SessionService */],
            ...
            __WEBPACK_IMPORTED_MODULE_7__services_recipes_service__["a" /* RecipesService */],
            __WEBPACK_IMPORTED_MODULE_9__services_plan_service__["a" /* PlanService */],
            __WEBPACK_IMPORTED_MODULE_8__services_form_helper_service__["a" /* FormHelperService */],
            __WEBPACK_IMPORTED_MODULE_10_app_services_shopping_list_service__["a" /* ShoppingListService */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_12_app_app_shell_app_shell_component__["a" /* AppShellComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_3__app_routing__["a" /* AppRoutingModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClientModule */],
            __WEBPACK_IMPORTED_MODULE_13_app_modules_recipe_recipe_module__["a" /* RecipeModule */],
            __WEBPACK_IMPORTED_MODULE_14_app_modules_inventory_inventory_module__["a" /* InventoryModule */],
            __WEBPACK_IMPORTED_MODULE_15_app_modules_plan_plan_module__["a" /* PlanModule */],
            __WEBPACK_IMPORTED_MODULE_16_app_modules_welcome_welcome_module__["a" /* WelcomeModule */]
        ],
        bootstrap: [__WEBPACK_IMPORTED_MODULE_12_app_app_shell_app_shell_component__["a" /* AppShellComponent */]]
    })
], AppModule);
...
var RecipeDetailComponent = (function (_super) {
    ...
    RecipeDetailComponent.prototype.getPlans = function () {
        var _this = this;
        this.planService.getUpcomingPlans().subscribe(function (values) {
            _this.plansSelect = new Array();
            _this.plans = new Array();
            if (values.length > 0) {
                for (var i = 0; i < values.length; i++) {
                    _this.plansSelect.push(new __WEBPACK_IMPORTED_MODULE_17_app_classes_selectItem__["a" /* SelectItem */](String(i), __WEBPACK_IMPORTED_MODULE_0_moment__(values[i].dateTime).format('dddd, MMM Do')));
...
var HomePublicComponent = (function () {
    ...
    HomePublicComponent.prototype.ngOnInit = function () {
        ...
        this.sessionManager.loggedInUser.subscribe(function (value) {
            _this.session = value;
            if (_this.session && _this.session != null) {
                if (_this.session.serviceError && _this.session.serviceError != null) {
                    _this.failure = _this.session.serviceError.message;
                }
                if (_this.session.userAuth && _this.session.userAuth != null) {
...
/***/ "../../../../../src/app/services/BaseRestService.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_classes_error__ = __webpack_require__("../../../../../src/app/classes/error.ts");
...
var BaseRestService = (function () {
    function BaseRestService(httpClient, sessionService, resource) {
        this.httpClient = httpClient;
        this.endpoint = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].serviceUrl + resource + '/';
        this.serviceUrl = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].serviceUrl;
        this.sessionService = sessionService;
    }
    BaseRestService.prototype.getAuthHeader = function () {
        var opts = {
    ...
    BaseRestService.prototype.handleError = function (res) {
        var error = new __WEBPACK_IMPORTED_MODULE_5_app_classes_error__["a" /* ServiceError */]();
...
AuthGuard = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_app_services_session_service__["a" /* SessionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_app_services_session_service__["a" /* SessionService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === "function" && _b || Object])
], AuthGuard);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_services_BaseRestService__ = __webpack_require__("../../../../../src/app/services/BaseRestService.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_services_session_service__ = __webpack_require__("../../../../../src/app/services/session.service.ts");
...
var CategoriesService = (function (_super) {
    ...
    function CategoriesService(httpClient, sessionService) {
        return _super.call(this, httpClient, sessionService, 'category') || this;
    }
    ...
    CategoriesService.prototype.getCategories = function () {
        return this.httpClient.get(this.endpoint, this.getAuthHeader()).catch(this.handleError);
    };
    CategoriesService.prototype.saveCategory = function (value) {
        var options = this.getAuthHeader();
...
}(__WEBPACK_IMPORTED_MODULE_5_app_services_BaseRestService__["a" /* BaseRestService */]));
CategoriesService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_core__["w" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_6_app_services_session_service__["a" /* SessionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_app_services_session_service__["a" /* SessionService */]) === "function" && _b || Object])
], CategoriesService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("../../../common/@angular/common/http.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_services_BaseRestService__ = __webpack_require__("../../../../../src/app/services/BaseRestService.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_services_session_service__ = __webpack_require__("../../../../../src/app/services/session.service.ts");
...
var ItemsService = (function (_super) {
    ...
    function ItemsService(httpClient, sessionService) {
        return _super.call(this, httpClient, sessionService, 'items') || this;
    }
    ItemsService.prototype.getItems = function (searchText) {
        return this.httpClient.get(this.endpoint + 'search/' + searchText, this.getAuthHeader()).catch(this.handleError);
    };
    return ItemsService;
}(__WEBPACK_IMPORTED_MODULE_3_app_services_BaseRestService__["a" /* BaseRestService */]));
ItemsService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["w" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4_app_services_session_service__["a" /* SessionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_app_services_session_service__["a" /* SessionService */]) === "function" && _b || Object])
], ItemsService);
...
var PlanService = (function (_super) {
    ...
    function PlanService(httpClient, sessionService) {
        return _super.call(this, httpClient, sessionService, 'plan') || this;
    }
    PlanService.prototype.getUpcomingPlans = function () {
        return this.httpClient.get(this.endpoint + 'upcoming/14', this.getAuthHeader()).catch(this.handleError);
    };
    PlanService.prototype.getPreviousPlans = function (page) {
        if (!page) {
            page = 0;
        }
        return this.httpClient.get(this.endpoint + 'closed/' + page, this.getAuthHeader()).catch(this.handleError);
    };
...
var RecipesService = (function (_super) {
    __extends(RecipesService, _super);
    function RecipesService(httpClient, sessionService) {
        return _super.call(this, httpClient, sessionService, 'recipe') || this;
    }
    RecipesService.prototype.getRecipeView = function (key) {
        if (!key) {
            ...
            return this.httpClient.get(this.endpoint + 'viewrecipe/' + key).catch(this.handleError);
        }
    };
    ...
    RecipesService.prototype.getRecipeType = function (id) {
        if (!id) {
            ...
            return this.httpClient.get(this.serviceUrl + 'recipetype/' + id, this.getAuthHeader()).catch(this.handleError);
        }
    };
    RecipesService.prototype.getRecipieTypes = function () {
        return this.httpClient.get(this.serviceUrl + 'recipetype/', this.getAuthHeader()).catch(this.handleError);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_classes_LoginDto__ = __webpack_require__("../../../../../src/app/classes/LoginDto.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_services_BaseRestService__ = __webpack_require__("../../../../../src/app/services/BaseRestService.ts");
...
var SessionService = (function (_super) {
    ...
    function SessionService(httpClient) {
        var _this = _super.call(this, httpClient, null, 'account') || this;
        _this.sessionKey = 'kh_suser';
        _this.loggedInUser = new __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__["BehaviorSubject"](_this.getUser());
    ...
    SessionService.prototype.hasAccessToken = function () {
    ...
    SessionService.prototype.handleLogin = function (evt) {
        ...
        if (isSignedIn) {
            ...
            var existingUser = this.getUser();
            var user_1;
            if (existingUser && existingUser != null) {
                user_1 = existingUser;
            }
            else {
                user_1 = new __WEBPACK_IMPORTED_MODULE_4_app_classes_userSession__["a" /* UserSession */](profile);
            }
            user_1.googleToken = currentUser.getAuthResponse().id_token;
            this.setUser(user_1);
            if (!user_1.userAuth || user_1.userAuth == null) {
                this.getAuthToken(user_1).subscribe(function (token) {
                    user_1.userAuth = token;
                    _this.setUser(user_1);
                }, function (error) {
                    user_1.serviceError = error;
                    _this.setUser(user_1);
                });
            }
        }
    ...
    SessionService.prototype.getAuthToken = function (account) {
        var dto = new __WEBPACK_IMPORTED_MODULE_5_app_classes_LoginDto__["a" /* LoginDto */](account.googleToken);
        return this.httpClient.post(this.endpoint + "login", dto).catch(this.handleError);
    };
    return SessionService;
}(__WEBPACK_IMPORTED_MODULE_6_app_services_BaseRestService__["a" /* BaseRestService */]));
...
var ShoppingListService = (function (_super) {
    __extends(ShoppingListService, _super);
    function ShoppingListService(httpClient, sessionService) {
        return _super.call(this, httpClient, sessionService, 'list') || this;
    }
    ShoppingListService.prototype.getOpenList = function () {
        return this.httpClient.get(this.endpoint + 'open', this.getAuthHeader()).catch(this.handleError);
    };
    ShoppingListService.prototype.generateList = function () {
        var opts = this.getAuthHeader();
        opts.responseType = 'text';
        return this.httpClient.get(this.endpoint + 'generate', opts).catch(this.handleError);
    };
    ShoppingListService.prototype.getList = function (id) {
        return this.httpClient.get(this.endpoint + 'details/' + id, this.getAuthHeader()).catch(this.handleError);
    };
    ...
    ShoppingListService.prototype.updateList = function (value) {
        return this.httpClient.put(this.endpoint + value.id, value, this.getAuthHeader()).catch(this.handleError);
    };
